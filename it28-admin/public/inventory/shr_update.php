...
$title_err = $description_err = $price_err = $img_err = "";
   ...
   $sql = "SELECT * FROM semi_hyperrealistic WHERE shr_id = :shr_id";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
   ...
   // Check input errors before updating in database
    ...
    $sql = "UPDATE semi_hyperrealistic SET title = :title, description = :description, price = :price, img = :img WHERE shr_id = :shr_id";
    ...
    if ($stmt = $pdo->prepare($sql)) {
        ...
        $stmt->bindParam(":shr_id", $shr_id); // Add parameter for the portrait_id

        // Set the portrait ID
        $shr_id = $_POST["shr_id"]; // Assuming you have a hidden input field named "shr_id" in your form
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <input type="hidden" name="shr_id" value="<?php echo $_GET["shr_id"]; ?>"/>
